...
<body>
    ...
    <div class="container">
        <div class="search-bar">
            <input type="search" id="search-input" placeholder="Cari Produk CLUCTH">
            <span class="search-icon">&#128269;</span> <!-- Ikon pencarian -->
        </div>

        <img src="{{ asset('image/clucth.jpeg') }}" alt="CLUCTH" class="img">
        <h2 class="text-center my-4">Produk CLUCTH</h2>
